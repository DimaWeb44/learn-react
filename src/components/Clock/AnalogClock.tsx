...
type PropsType = {}
export const AnalogClock: React.FC<PropsType> = (props: PropsType) => {
    ...
    return <div>
        <div className={`${s["clock-container"]} ${s["styling"]}`}>
            <div id={s["clock"]} className={s["clock-content"]}>

                <svg className={s["background-numbers"]} viewBox="0 0 226.6 233.8">
                    <path className={s["numbers"]}
                ...
                <div
                    id={s["hours-indicator"]}
                    className={
                        ` ${s["indicator"]} ${s["hours-indicator"]} +
                        ${(date.getHours() === 0 ? "" : s["transition-effect"])}`
                    }
                    style={divStyleHours}></div>
                <div
                    id={s["minutes-indicator"]}
                    className={
                        ` ${s["indicator"]} ${s["minutes-indicator"]} +
                        ${(date.getMinutes() === 0 ? "" : s["transition-effect"])}`
                    }
                    style={divStyleMinutes}></div>
                <div
                    id={s["seconds-indicator"]}
                    className={
                        ` ${s["indicator"]} ${s["seconds-indicator"]} +
                        ${(date.getSeconds() === 0 ? "" : s["transition-effect"])}`
                    }
                    style={divStyleSeconds}></div>
                <div className={s["indicator-cover"]}></div>
            </div>
        </div>
    </div>
